...
- [`7ace314`](https://github.com/willclarktech/morph/commit/7ace314d29eab2a8bbdd59d26110ccc30dbb7f35) Thanks [@willclarktech](https://github.com/willclarktech)! - Make `new-project` produce a project that passes `bun install && bun run build:check` end-to-end:
